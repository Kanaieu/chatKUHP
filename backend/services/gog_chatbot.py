...
class PlanningModel:
    ...
    def _rewrite_query(self, task: str) -> str:
        ...
        prompt = (
            ...
            "- 'Melempar batu ke kereta api', 'bahaya rel kereta' → SENGAJA menimbulkan bahaya lalu lintas kereta api (Pasal 323), BUKAN kekerasan massa di muka umum (Pasal 262).\n"
            ...
            "- 'Hoaks', 'berita bohong', 'penyebaran informasi palsu' → PENYIARAN BERITA BOHONG (Pasal 263), BUKAN ajaran komunisme (Pasal 188).\n"
            ...
            "- Cerita: 'Saya mau bertanya apakah ada hukum yang dapat menjerat pelaku penyiksaan terhadap hewan?' -> Query: Penganiayaan hewan, menyakiti melukai hewan, Pasal 337\n"
